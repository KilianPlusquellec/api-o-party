...
INSERT INTO event(title, description, start_date, finish_date, start_hour, address, zip_code_city, location, privacy_type, picture, max_attendee, status, pmr_access, user_id) VALUES 
('Concert Rock', 'Un super concert de rock en plein air.', '2024-07-09', '2024-07-09', '19:00:00', '8, rue du Centre', '75007 Paris', ST_GeogFromText('SRID=4326;POINT(48.8549158 2.3128591)'), FALSE, null, 100, TRUE, TRUE, 2),
('Soirée électro ', 'découvrez le meilleur DJ de Lyon.', '2024-08-01', '2024-08-01', '22:00:00', '7, rue des Lilas', '69000 Lyon', ST_GeogFromText('SRID=4326;POINT(45.5603292 4.8064673)'), FALSE, 'https://avatars.githubusercontent.com/u/157673098?v=4', 120, TRUE, TRUE, 1),
('Concert Jazz', 'Concert des plus grands artistes Jazz .', '2024-09-05', '2024-09-06', '21:00:00', '12, rue de l''Eglise', '13011 Marseille', ST_GeogFromText('SRID=4326;POINT(43.2855958 5.4123418)'), TRUE, null, 30, TRUE, FALSE, 3),
('Rave party', 'Rave party dans ma campagne.', '2024-10-20', '2024-10-23', '20:00:00', '1, chemin de Saint-Hubert', '95760 Valmondois', ST_GeogFromText('SRID=4326;POINT(49.0973 2.19)'), FALSE, 'https://avatars.githubusercontent.com/u/157001794?v=4', 200, 'TRUE', TRUE, 3);
